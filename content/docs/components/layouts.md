...
In this example, we want to render the main content of our welcome page using our `$slots.main` function, add a meta markup with `$slots.meta`, and change the default title. 
